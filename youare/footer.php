...
?> 
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<p class="pright"><small><a class="wordpress" href="http://wordpress.org" title="<?php _e('WordPress','youare'); ?>"><?php _e('WordPress','youare'); ?></a> &middot; <?php $rss_url = get_option('y_feedburner_username'); 
						if ($rss_url != "") {
							echo '<a class="rss" href="http://feeds.feedburner.com/' . $rss_url . '">';
							_e('RSS','youare');
							echo '</a>';
						} else { ?>
							<a class="rss" href="<?php bloginfo('rss2_url'); ?> "><?php _e('RSS', 'youare'); ?></a></li>
						<?php } ?> &middot; <a href="#header" id="toplink" title="<?php _e('Top', 'youare'); ?>"><?php _e('Top', 'youare'); ?></a></small></p>
						<?php include (COPY); ?>
				</div>
			</div><!--end footer-->
		</div>
