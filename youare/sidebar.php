<div id="sidebar" class="col-md-4 col-xs-12">
	...
	<?php
		...
		<a class="more" href="<?php echo get_permalink('2') ?>"><?php _e('Read more', 'youare'); ?></a>
<?php 
    	} else {
			_e('Go to YouAre Options menu in your WP Dashboard and check out the Author Box Sidebar section.', 'youare'); 
		}
...
?>    </div>
	...
	<?php } 
	$fbId = get_option('y_feedburner_email'); //Your Feedburner Username 
	if ( !empty($fbId) ) {?>
